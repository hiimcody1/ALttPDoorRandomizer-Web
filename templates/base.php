		...
		<header class="p-3 border-bottom">
			<div class="container">
				<nav class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
						...
						<span class="me-2"><i class="bi bi-door-open"></i><i class="bi bi-shuffle fs-4"></i></span>
						</a>
					<div class="px-5"></div>
		...
		<footer class="footer mt-auto py-3 bg-light">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm">
						<span class="text-muted float-end text-end"><small>Using DoorRandomizer <?php echo Config::DoorsVersion;?><br />This project wouldn't be possible without the contributions of the Door Randomizer developers</small></span>
					</div>
				</div>
			</div>
		</footer>
